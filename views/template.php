...
<body>
	<div class="wrapper">
		...
		<div class="content">
			<br>
			<h1>Example Table</h1>
			<span class="col-md-4">Item 1</span>
			<span class="col-md-4">Item 2</span>
			<span class="col-md-4">Item 3</span>
...
<script type="text/javascript" charset="utf8" src="<?php echo site_url('../../../../../js/dataTables.bootstrap.js'); ?>"></script>
